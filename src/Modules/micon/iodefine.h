...
*            : 2.0   (2013-02-17)  [Hardware Manual Revision : 2.00]
*            : 2.1   (2013-07-17)  [Hardware Manual Revision : 2.10]
*            : 2.1B  (2015-04-22)  [Hardware Manual Revision : 2.10]
*
* NOTE       : THIS IS A TYPICAL EXAMPLE.
*
* Copyright (C) 2015 (2012 - 2013) Renesas Electronics Corporation.
*
*********************************************************************************/
/*                                                                              */
...
struct st_s12ad {
	...
	char           wk16[16];
	union {				// ADFSPMR register is available only for S12AD0 module..
		unsigned short WORD;
		struct {
			unsigned short PGSC:1;
			unsigned short :15;
		} BIT;
	} ADGSPMR;
};
